...
class STokenAdapter extends BaseAdapter{
    private List<DTokens> listtokens;
    private Context context;
    public STokenAdapter(Context context, List<DTokens> listtokens) {
    ...
    public View getView(int arg0, View arg1, ViewGroup arg2) {
        DTokens entry = listtokens.get(arg0);
        if (arg1 == null) {
